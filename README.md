...
ทั้ง `workflow-zozeei` และ `security-zozeei` รายงาน token usage จริงเมื่อ runtime เปิดเผย พร้อมขอบเขตและค่า input/output/cached เท่าที่มี หาก runtime ไม่เปิดเผยจะระบุตรง ๆ โดยไม่ประมาณตัวเลขหรือค่าใช้จ่าย
